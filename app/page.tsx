    ...
    <main className="min-h-screen flex flex-col bg-background text-white selection:bg-gymRed">
      ...
      <section className="relative px-4 sm:px-6 pt-0 pb-16 sm:pt-6 sm:pb-20 flex-1 max-w-4xl mx-auto w-full text-center flex flex-col items-center justify-center">
        ...
        <p className="text-base sm:text-lg text-zinc-400 max-w-xl mb-8 leading-relaxed">
          The ultimate gym weight loss competition across our 6 clubs.
          Register online, visit any branch for your Day-1 weigh-in, and start your 30-day countdown!
        </p>
        ...
        {windowStatus.isOpen ? (
          <div className="w-full max-w-sm flex flex-col items-center gap-3">
            ...
            <a href="https://www.instagram.com/faceoff.fitness?stkn=NTB3bG9rZmw3Zmhv" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-zinc-900/90 border border-pink-500/40 hover:border-pink-500 hover:bg-pink-950/30 text-xs text-zinc-300 hover:text-white transition-all group shadow-sm" title="Follow use on Instragram">
              <svg className="w-3.5 h-3.5 text-pink-500 fill-current shrink-0 group-hover:scale-110 transition-transform" viewBox="0 0 24 24">
              ...
              <span>Must follow <strong className="text-white decoration-pink-500/60 underline-offset-2">@faceoff.fitness</strong> on Instagram</span>
            </a>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            ...
            <div className="gym-card rounded-xl p-4 sm:p-5 flex flex-col items-start text-left">
              ...
              <p className="text-zinc-400 text-xs leading-relaxed">
                Visit any branch and present your QR code. Our team will record your official baseline weight to officially activate your 30-day challenge.
              </p>
            </div>
            ...
            <div className="gym-card rounded-xl p-4 sm:p-5 flex flex-col items-start text-left">
              ...
              <p className="text-zinc-400 text-xs leading-relaxed">
                Return to any branch on 30th day for your final weigh-in. Our team will record your results, capture your digital sign, and email your official verified certificate.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 px-4 sm:px-6 max-w-4xl mx-auto w-full">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {branches.map((b) => (
            <div key={b.id} className="gym-card rounded-xl p-3.5 text-center flex flex-col items-center gap-1.5">
              <MapPin className="w-4 h-4 text-gymRed" />
              <span className="font-semibold text-sm text-white">{b.label}</span>
              <span className="text-[10px] text-zinc-400">{b.address || "Official Branch"}</span>
            </div>
          ))}
        </div>
      </section>
